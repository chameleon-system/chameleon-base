...
class ChameleonSystemViewRendererExtension extends ConfigurableExtension
{
    ...
    protected function loadInternal(array $mergedConfig, ContainerBuilder $container)
    {
        ...
        $lessCompiler->replaceArgument(1, ['STATIC_CONTENT_URL' => '"'.$mergedConfig['static_content_url'].'"']);
        // NOTE must be included in .less something like: url("@{STATIC_CONTENT_URL}")
        //   - because the quotes here are necessary for preprocessing or a URL in the less compiler.
    }
}
