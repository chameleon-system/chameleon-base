...
<div class="MTPkgNewsletterSignup">
    <div class="standard">
        <div class="headline"><?=TGlobal::OutHTML($oNewsletterConfig->fieldSignupHeadline); ?></div>
        <div class="newsletterSignup">
            <form name="newnestlettersign" accept-charset="utf-8" method="post"
                  action="<?=$data['aMainModuleInfo']['URL']; ?>">
                <input type="hidden" name="module_fnc[<?=TGlobal::OutHTML($data['aMainModuleInfo']['spotname']); ?>]"
                       value="SignUp"/>

                <div class="introtext"><?=$oNewsletterConfig->GetTextField('signup_text'); ?></div>
                <div class="formdata">
                    <?php
                    ...
                    <div class="inputbox_firstname inputbox">
                        ...
                        <div class="right">
                            ...
                            ?>
                            <?=TTemplateTools::InputField(MTPkgNewsletterSignupCore::INPUT_DATA_NAME.'[firstname]', $sValue, 100, '', 'text', true); ?>
                            <?php
                    ...
                    <div class="inputbox_lastname inputbox">
                        ...
                        <div class="right">
                            ...
                            ?>
                            <?=TTemplateTools::InputField(MTPkgNewsletterSignupCore::INPUT_DATA_NAME.'[lastname]', $sValue, 170, '', 'text', true); ?>
                            <?php
                    ...
                    <div class="inputbox_email inputbox">
                        ...
                        <div class="right">
                            ...
                            ?>
                            <?=TTemplateTools::InputField(MTPkgNewsletterSignupCore::INPUT_DATA_NAME.'[email]', $sValue, 181, '', 'text', true); ?>
                            <?php
                        ...
                        <div class="right">
                            ...
                            <div class="newslcheck">
                                <div class="left"><input id="all" type="checkbox"
                                                         name="<?=TGlobal::OutHTML(MTPkgNewsletterSignupCore::INPUT_DATA_NAME.'[newsletter][all]'); ?>"
                            ...
                            <div class="newslcheck">
                                ...
                                ?>
                                <div class="left"><input id="newsletter_<?=$oNesletter->id; ?>" class="newsletterchecker"
                                                         type="checkbox"
                                                         name="<?=TGlobal::OutHTML(MTPkgNewsletterSignupCore::INPUT_DATA_NAME.'[newsletter]['.$oNesletter->id.']'); ?>"
                                                         onclick="if(!$(this).attr('checked')){ $('#all').attr('checked',''); }"/>
                                </div>
                                <?php
                            } ?>
                                <div class="right"><label
                                    for="newsletter_<?=$oNesletter->id; ?>"><?=TGlobal::OutHTML($oNesletter->fieldName); ?></label>
                                </div>
                                <div class="cleardiv">&nbsp;</div>
                            </div>
                            <?php } ?>
