...
class DemographicWidget extends DashboardWidget implements RestrictedByCmsGroupInterface
{
    private const WIDGET_NAME = 'widget-google-analytics-demographic';
    ...
    public function getTitle(): string
    {
        return $this->translator->trans(
            'chameleon_system_cms_dashboard.widget.google_analytics.demographic_title',
            [
    ...
    public function getDropdownItems(): array
    {
        $dropDownMenuItem = new WidgetDropdownItemDataModel(
            'googleAnalyticsDemographicWidget',
    ...
    protected function generateBodyHtml(): string
    {
        ...
        $demographicData = $this->googleAnalyticsService->getDemographyData(
        ...
        $this->renderer->AddSourceObject('demographicData', $demographicData);

        $renderedTable = $this->renderer->Render('CmsDashboard/google-analytics/demographic-widget.html.twig');
