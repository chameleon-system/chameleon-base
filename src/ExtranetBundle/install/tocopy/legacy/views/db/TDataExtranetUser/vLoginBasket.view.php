...
<div class="TDataExtranetUser">
    ...
    ?><input type="hidden" name="sFailureURL"
                                                                                      value="<?=TGlobal::OutHTML($aCallTimeVars['sFailureURL']); ?>"/><?php
} ?>
                <?php if (array_key_exists('sSuccessURL', $aCallTimeVars)) {
        ?><input type="hidden" name="sSuccessURL"
                                                                                      value="<?=TGlobal::OutHTML($aCallTimeVars['sSuccessURL']); ?>"/><?php
    } ?>
                ...
                <table class="userinput" summary="">
                    ...
                    <tr>
                        <th>&nbsp;</th>
                        <td><a href="<?=$oExtranetConfig->GetLinkForgotPasswordPage(); ?>" rel="nofollow">Passwort
                            vergessen?</a></td>
                    </tr>
                </table>
