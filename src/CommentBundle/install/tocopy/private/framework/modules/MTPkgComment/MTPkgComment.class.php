    ...
    public function GetHtmlHeadIncludes()
    {
      ...
      <script type=\"text/javascript\">
        ...
        $('#comment_preview_button').toggle(function(){
          ...
          $(this).html('".TGlobal::OutHtml(TGlobal::Translate('chameleon_system_comment.action.edit'))."');
        },function(){
          $('#comment_preview').hide();
          $('#comment_form').show();
          $(this).html('".TGlobal::OutHtml(TGlobal::Translate('chameleon_system_comment.action.preview'))."');
        });
      });
      </script>";
