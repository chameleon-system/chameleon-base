    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="place" id="place" placeholder="<?=TGlobal::OutHTML($translator->trans('chameleon_system_core.google_map.address')); ?>">
            <div class="input-group-btn">
                <button class="btn btn-default" type="button" id="btnFindAddress"><i class="glyphicon glyphicon-search" title="<?=TGlobal::OutHTML($translator->trans('chameleon_system_core.google_map.find_coordinates')); ?>"></i></button>
            </div>
        </div>
    </div>
