...
$oViewRenderer->AddSourceObject('sButton', TCMSRender::DrawButton(TGlobal::Translate('chameleon_system_core.cms_module_wysiwyg_image.upload'), 'javascript:openUploadDialog();', 'fas fa-upload'));
