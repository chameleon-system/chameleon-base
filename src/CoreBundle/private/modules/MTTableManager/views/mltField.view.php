            ...
            <td>
                <div style="padding-left: 2px;">
                    <div class="btn-group">
                            ...
                            $oViewRenderer->AddSourceObject('sOnClick', "parent.CreateModalIFrameDialogCloseButton('".TGlobal::OutHTML($url)."',900,600,'".TGlobal::Translate('chameleon_system_core.field_lookup_multi_select.action_connect_records')."');");
                            ...
                            <?php if (!empty($data['bShowCustomSort'])) {
                                ...
                                $oViewRenderer->AddSourceObject('sOnClick', "parent.CreateModalIFrameDialogCloseButton('".TGlobal::OutHTML($sSortUrl)."',900,600,'".TGlobal::Translate('chameleon_system_core.field_lookup_multi_select.action_sort_connections')."');");
