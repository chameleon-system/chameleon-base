...
?>
<br/>
<h1><?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_robinson_import.headline'); ?></h1>
...
<form name="import" method="post" action="<?=PATH_CMS_CONTROLLER; ?>" enctype="multipart/form-data">
    ...
    &nbsp;<BR>
    <?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_robinson_import.import_file_help'); ?>
    <br/>&nbsp;<br/>
    <table cellpadding="3" cellspacing="2" border="0">
        <tr>
            <td><?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.text.portal'); ?>:&nbsp;&nbsp;&nbsp;</td>
        ...
        <tr>
            <td><?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_robinson_import.source'); ?>:&nbsp;&nbsp;&nbsp;</td>
