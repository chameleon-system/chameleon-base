...
<form name="importCSV" method="post" action="<?=PATH_CMS_CONTROLLER; ?>" enctype="multipart/form-data">
    ...
    &nbsp;<BR>
    <?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_import.import_file_help'); ?>
    <br/>
    ...
    <br/>
    <?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_import.import_file_help_salutation', array('%patterns%' => 'm/w; m/f; male/female; Mr/Mrs; Herr/Frau')); ?>
    <br/>&nbsp;<br/>
    <table cellpadding="3" cellspacing="2" border="0">
        <tr>
            <td><?=TGlobal::OutHTML(\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_import.group')); ?>:&nbsp;&nbsp;&nbsp;</td>
            <td colspan="2"><select name="pkg_newsletter_group_id">
                <option value="noGroup"><?= TGlobal::OutHTML(\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_import.no_group')); ?></option>
                <?php
        ...
        <tr>
            <td><?=TGlobal::OutHTML(\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_import.portal_help')); ?>:&nbsp;&nbsp;&nbsp;</td>
        ...
        <tr>
            <td><?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_import.replace_subscribers'); ?>:&nbsp;&nbsp;&nbsp;</td>
            <td colspan="2"><input type="checkbox" name="replaceAllSubscriber" value="true"/></td>
        </tr>
        <tr>
            <td><?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_import.update_group_only'); ?>
                :&nbsp;&nbsp;&nbsp;</td>
            <td colspan="2"><input type="checkbox" name="notupdateSubscriber" value="true"/></td>
        </tr>
        <tr>
            <td><?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_import.source'); ?>:&nbsp;&nbsp;&nbsp;</td>
...
<div id="confirmReplaceDialog" style="display:none;">
    <?=\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.cms_module_newsletter_import.confirm_replace'); ?>
    <br \>
    <br \>
    <?php
