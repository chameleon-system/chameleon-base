...
<div class="card card-accent-primary mb-2" id="templateengine">
    ...
    <iframe name="userwebpage" id="userwebpageiframe" frameborder="0"
            src="<?=PATH_CMS_CONTROLLER_FRONTEND?>?pagedef=<?=TGlobal::OutHTML(urlencode($data['oPage']->id)); ?>&amp;__modulechooser=true&amp;id=<?=TGlobal::OutHTML(urlencode($data['oPage']->id)); ?>&amp;entropy=<?=md5(rand()); ?>&amp;esdisablelinks=true&amp;esdisablefrontendjs=true&amp;__previewmode=true&amp;previewLanguageId=<?=$backendSession->getCurrentEditLanguageId(); ?>"
