...
obj['create'] = {
"label"             : "<?= TGlobal::OutJS(TGlobal::Translate('chameleon_system_core.cms_module_tree_widget.action_new_node')); ?>",
...
obj['remove'] = {
"label"             : "<?= TGlobal::OutJS(TGlobal::Translate('chameleon_system_core.cms_module_tree_widget.action_delete')); ?>",
...
obj['upload'] = {
"label"             : "<?= TGlobal::OutJS(TGlobal::Translate('chameleon_system_core.cms_module_tree_widget.action_upload')); ?>",
"action"            : function (obj) {
...
obj['uploadlocal'] = {
"label"             : "<?= TGlobal::OutJS(TGlobal::Translate('chameleon_system_core.cms_module_tree_widget.action_import_ftp')); ?>",
"action"            : function (obj) {
var sNodeID = obj.attr("id").replace("node","");
...
if(bHasEditPermission) {
obj['pastefiles'] = {
"label"             : "<?= TGlobal::OutJS(TGlobal::Translate('chameleon_system_core.cms_module_tree_widget.action_move_to_here')); ?>",
"action"            : function (obj) {
var sNodeID = obj.attr("id").replace("node","");
PasteFiles(sNodeID);
},
...
obj['rename'] = {
// The item label
"label"             : "<?= TGlobal::OutJS(TGlobal::Translate('chameleon_system_core.cms_module_tree_widget.action_rename')); ?>",
