...
function gcf_ShowOnlyTinyImage($field, $row, $fieldName)
{
    ...
    if ('flv' === $oImage->GetImageType() || 'f4v' === $sImageType) {
        $imageTag = $oImage->GetThumbnailTag(40, 40, null, null, '');
    } else {
        $oThumbnail = $oImage->GetThumbnail(40, 40);
