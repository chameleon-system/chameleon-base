...
class TCMSListManagerDocumentManagerSelected extends TCMSListManagerFullGroupTable
{
    ...
    public function AddFields()
    {
        ...
        ++$this->columnCount;
        $this->tableObj->AddHeaderField(['cms_filetype_id' => TGlobal::Translate('chameleon_system_core.list_document.file_type')], 'left', null, 1, false);
        $this->tableObj->AddColumn('cms_filetype_id', 'left', [$this, 'CallBackGenerateDownloadLink'], null, 1);

        ++$this->columnCount;
        $this->tableObj->AddHeaderField(['name' => TGlobal::Translate('chameleon_system_core.list_document.title')], 'left', null, 1, false);
        $this->tableObj->AddColumn('name', 'left', null, $jsParas, 1);
        $this->tableObj->searchFields['`cms_document`.`name`'] = 'full';

        ++$this->columnCount;
        $this->tableObj->AddHeaderField(['filename' => TGlobal::Translate('chameleon_system_core.list_document.file_name')], 'left', null, 1, false);
        ...
        ++$this->columnCount;
        $this->tableObj->AddHeaderField(['filesize' => TGlobal::Translate('chameleon_system_core.list_document.file_size')], 'left', null, 1, false);
