...
<div class="ModuleFeedback">
    ...
    <form method="post" action="">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <th>Ihr Name:</th>
                <td>
                    <input type="text" name="name" value="<?=TGlobal::OutHTML($aInput['name']); ?>"/>
    ...
    ?>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="email" value="<?=TGlobal::OutHTML($aInput['email']); ?>"/>
        ...
        ?>
            ...
            <tr>
                <th>Betreff:</th>
                <td>
                    <input type="text" name="subject" value="<?=TGlobal::OutHTML($aInput['subject']); ?>"/>
        ...
        ?>
            ...
            <tr>
                <th>Ihre Anfrage:</th>
                <td>
                    <textarea name="body" rows="" cols=""><?=TGlobal::OutHTML($aInput['body']); ?></textarea>
