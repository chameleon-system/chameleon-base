...
class TCMSMediaFieldMapper extends AbstractViewMapper
{
    ...
    public function Accept(IMapperVisitorRestricted $oVisitor, $bCachingEnabled, IMapperCacheTriggerRestricted $oCacheTriggerManager)
    {
        ...
        $sHTMLManageMediaButton = TCMSRender::DrawButton(TGlobal::Translate('chameleon_system_core.link.open_media_manager'), "javascript:loadMediaManager('".$sRecordId."','".$sTableId."','".$sFieldName."');", URL_CMS.'/images/icons/image.gif');
