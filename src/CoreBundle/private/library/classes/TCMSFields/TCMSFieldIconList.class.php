...
class TCMSFieldIconList extends TCMSField implements DoctrineNotTransformableInterface
{
    public function GetHTML()
    {
      ...
      <span id="'.TGlobalBase::OutHTML($this->name)."posDummy\"></span>\n";
        ...
        $html .= TCMSRender::DrawButton(TGlobal::Translate('chameleon_system_core.field_icon_list.select'), "javascript:CreateModalIFrameDialogCloseButton('{$url}',0,0,'".TGlobal::Translate('chameleon_system_core.field_icon_list.select')."');", 'far fa-image');
