...
class TCMSFieldDownloads extends TCMSFieldLookupMultiselect
{
    ...
    public function GetHTML()
    {
      ...
      <div>';
        ...
        $html .= TCMSRender::DrawButton(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_core.link.open_document_manager'), "javascript:loadDocumentManager('".$this->recordId."','".$this->oTableConf->id."','".$this->name."', '".$this->GetMLTTableName()."');", 'fas fa-file');
        $html .= '</div>
