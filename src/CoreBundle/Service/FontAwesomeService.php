...
class FontAwesomeService implements FontAwesomeServiceInterface
{
    ...
    public function isFontAwesomeBrand(string $cssClass): bool
    {
        $cssClass = \str_replace([':before', '.', 'fab'], '', $cssClass);
        $cssClass = trim(preg_replace('/\s+/', ' ', $cssClass));
        ...
        $isBrand = \in_array($cssClass, $fontAwesome5brands, true);
