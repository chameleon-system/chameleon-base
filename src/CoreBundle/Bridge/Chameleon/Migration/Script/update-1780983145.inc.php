...
<div class="changelog">
    - #70367: Add new field to export profiles to expand multi value fields
</div>
<?php
...
$data = TCMSLogChange::createMigrationQueryData('cms_field_conf', 'en')
    ->setFields([
        ...
        '049_helptext' => 'If active, all fields with a 1:n connection will be displayed with separate columns in the export.
